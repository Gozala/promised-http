(function() {
  'use strict';  var CONTENT_JSON, CONTENT_LENGTH, CONTENT_MULTIPART, CONTENT_TYPE, CONTENT_URL_ENCODED, DELETE, GET, HEAD, Options, POST, PUT, format, parse, toMultiPart, toQuery, _ref;
  _ref = require('url'), parse = _ref.parse, format = _ref.format;
  POST = 'POST';
  GET = 'GET';
  PUT = 'PUT';
  DELETE = 'DELETE';
